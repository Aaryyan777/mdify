      ...
      <div className="flex h-16 w-full max-w-screen-2xl mx-auto items-center justify-between min-w-0">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          <Link href="/" className="flex items-center gap-2 sm:gap-3">
            <Logo />
            <span
              className="text-white font-bold text-lg sm:text-xl font-bricolage"
              itemProp="name"
            >
              mdify
            </span>
        ...
        <nav className="hidden md:flex font-bricolage items-center gap-1 absolute left-1/2 transform -translate-x-1/2">
          <Link href="/how-to-convert-medium-to-markdown">
            <Button
              variant="ghost"
              size="sm"
              className="text-white/80 font-bricolage hover:text-white hover:bg-white/10 text-sm"
            >
              How to Use
            </Button>
          </Link>
