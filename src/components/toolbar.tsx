...
export function ReviewToolbar() {
  ...
  return (
    <div className="flex flex-col bg-black text-white border-b border-zinc-800">
      <div className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-bold font-mono">{`${title}.md`}</h3>
            <Dialog>
              <DialogTrigger asChild>
                <Button variant="ghost" size="icon" className="w-8 h-8 hover:bg-zinc-900 hover:text-white">
        ...
        <div className="flex items-center gap-4">
          <Button
            className="outline-none shadow-lg transform active:scale-95 transition-all hover:bg-zinc-900 hover:text-white"
            onClick={() => {
          ...
          <Button
            ...
            className="max-sm:hidden outline-none shadow-lg transform active:scale-95 transition-all hover:bg-zinc-900 hover:text-white"
            variant="ghost"
            size="sm"
          >
      ...
      <div className="flex items-center justify-between px-6 py-2 border-t border-zinc-800">
        <div className="flex items-center gap-1">
          <Button
            ...
            variant="ghost"
            size="icon"
            className="w-8 h-8 hover:bg-zinc-900 hover:text-white"
          >
          ...
          <Popover>
            ...
            <PopoverContent className="w-80 bg-black border-zinc-800">
                ...
                <div className="grid gap-2">
                  ...
                  <div className="grid grid-cols-3 items-center gap-1">
                    <Input
                      ...
                      className="col-span-2 h-8 w-full text-sm bg-zinc-900 border-zinc-800 text-white"
                      value={link}
                    ...
                    size="icon" className="w-full h-8 bg-white text-black hover:bg-zinc-200">
                      Add
                    </Button>
                  </div>
                </div>
          ...
          variant="ghost" size="icon" className="w-8 h-8 hover:bg-zinc-900 hover:text-white">
